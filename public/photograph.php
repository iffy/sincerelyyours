...
class Photograph extends DatabaseObject {
	...
	protected static $table_name="tbl_images";
	protected static $db_fields=array('image_id', 'username', 'type', 'images_path', 'submission_date', 'size', 'storyname', 'image_name');
	public $image_id;
	public $username;
	public $type;
	public $images_path;
  ...
  private $temp_path;
  protected $upload_dir= "images/"; //. $this->username; //do I need "/" in here?
  public $errors=array();
  ...
  public function attach_file($file) {
	...
	public function save() {
		...
		if(isset($this->image_id)) {
		  ...
		  if(strlen($this->image_name) > 255) {
				$this->errors[] = "The caption can only be 255 characters long.";
				return false;
			}
		
		  // Can't save without image_name and temp location
		  ...
		  $target_path = $this->upload_dir .'/'. $this->image_name;  //do I need "/" in here?
	...
	public function image_path() {
	  return $this->upload_dir . $this->image_name; //do I need "/" in here?
	}
  ...
  public static function find_by_sql($sql="") {
	...
	public function create() {
	  ...
	  if($database->query($sql)) {
	  	 $this->image_id = $database->insert_id();
	    return true;
	  } else {
	    return false;
	  }
	...
	public function update() {
	  global $database;
		...
		$sql .= " WHERE id=". $database->escape_value($this->image_id);
	  $database->query($sql);
